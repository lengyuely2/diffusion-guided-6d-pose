...
def convert_npz_to_json(idx, list_npz_paths):
    ...
    try:
        ...
        logging.warning("skip corrupt npz in json export: %s (%s)", npz_path, e)
        return []
    except Exception as e:
        logging.warning("skip npz in json export (load): %s (%s)", npz_path, e)
        return []
    results = []
    try:
        ...
        logging.warning("skip corrupt npz (mid-read) in json export: %s (%s)", npz_path, e)
        return []
    except Exception as e:
        logging.warning("skip npz in json export (convert): %s (%s)", npz_path, e)
        return []
    finally:
